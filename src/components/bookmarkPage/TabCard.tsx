    ...
    >
      <div className='flex items-center'>
        ...
        <DeleteEntry
          id={id}
          className={cn(
            "mx-2  cursor-pointer group-hover:opacity-100 transition duration-200   rounded-full hover:bg-background text-foreground hover:text-text max-sm:opacity-100",
